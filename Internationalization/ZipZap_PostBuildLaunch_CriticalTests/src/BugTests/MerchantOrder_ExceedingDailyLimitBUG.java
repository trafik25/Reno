      ...
      //******************************FILL OUT ORDER******************************
       ...
       //Change default value from 50 to 500
        ...
        //Customer First Name
         ...
         clearEmail1.clear();
         clearEmail1.sendKeys("timothythomas222xxx@gmail.com");
         
         //Enter in Client phone number
         WebElement enterPhone1 = wd.findElement(By.xpath(".//*[@id='form-field-mobile']"));
         enterPhone1.sendKeys("2665551212");
       ...
       //Change default value from 50 to 500
         ...
         //Customer First Name
          ...
          clearEmail2.clear();
          clearEmail2.sendKeys("timothythomas222xxx@gmail.com");
          
          //Enter in Client phone number
          WebElement enterPhone2 = wd.findElement(By.xpath(".//*[@id='form-field-mobile']"));
          enterPhone2.sendKeys("2665551212");
         ...
         //Change default value from 50 to 500
          ...
          //Customer First Name
           ...
           clearEmail4.clear();
           clearEmail4.sendKeys("timothythomas222xxx@gmail.com");
           
           //Enter in Client phone number
           WebElement enterPhone4 = wd.findElement(By.xpath(".//*[@id='form-field-mobile']"));
           enterPhone4.sendKeys("2665551212");
...
//              //******************************5th ORDERS CHECKOUT PAGE******************************
              ...
              clearEmail5.clear();
              clearEmail5.sendKeys("timothythomas222xxx@gmail.com");
              
              //Enter in Client phone number
              WebElement enterPhone5 = wd.findElement(By.xpath(".//*[@id='form-field-mobile']"));
              enterPhone5.sendKeys("2665551212");
