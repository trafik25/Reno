...
public class MerchantAgreement {
	...
	public static void main(String[] args) throws Exception {
        ...
        WebElement changeTab = wd.findElement(By.xpath(".//*[@id='tabs']/ul/li[5]/a"));
        changeTab.click();
      ...
      //.//*[@id='tabs']/ul/li[2]/a COMPANY 
        ...
        //Ensure agreement is visible for legal reasons .//*[@id='agreement']/fieldset
        WebElement verifyAgreement = wd.findElement(By.xpath(".//*[@id='agreement']/fieldset"));
        verifyAgreement.isDisplayed();
