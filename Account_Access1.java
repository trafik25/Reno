...
public class Account_Access {
	...
	public static void main(String[] args) throws Exception {
        ...
        WebElement accLink = wd.findElement(By.xpath(".//*[@id='page']/table/tbody/tr[2]/td[8]/a"));
        accLink.click();
        
        //***********************orders are displayed***********************

        
        //Customer Name column .//*[@id='page']/table/tbody/tr[1]/td[2]  (change tr[] value
        //Ensure orders are present
        WebElement orderName = wd.findElement(By.xpath(".//*[@id='page']/table/tbody/tr[1]/td[2]"));
        orderName.isDisplayed();
