...
//        assertTrue(wd.getPageSource().contains("ANNIE'S PARTY SHOP"));
//         assertTrue(wd.getPageSource().contains("535 W COMMERCE RD"));
//	      assertTrue(wd.getPageSource().contains("COMMERCE TOWNSHIP"));
//	     
//	      WebElement store = wd.findElement(By.xpath(".//*[@id='map-results']/tbody/tr[1]/th"));
//	      store.isDisplayed();
